...
En nommant un fichier .bib contenant vos références dans les metadata, vous pouvez citez vos références avec le \@, par exemple @R-base

Plus d'éléments de personnalisations disponibles via l'extension [bookdown](https://bookdown.org/yihui/bookdown/)
