...
#1 Calculez, pour chaque Etat, le nombre moyen d'abeilles en 2015 et en 2020, puis le nombre d'abeilles en +/- entre ces 2 périodes
   #quel Etat a le plus gagné d'abeilles entre les 2 périodes, lequel en a le plus perdu ?
#2 Calculez, pour chaque Etat en 2015 en 2020, le nombre d'abeilles perdues selon la cause
 #faites ensuite le total, pour chaque année, du nombre d'abeilles perdues selon la cause
 #quelle est la 1ere cause de mortalité des abeilles pour chacune de ces années ?
